...
export const updateWeather = function (lat, lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        card.innerHTML = `
            ...
            <div class="wrapper">
                <p class="heading">${parseInt(temp)}<sup>&deg;c</sup></p>

                <img src="./assets/images/weather_icons/${icon}.png" alt="${description}" height="64" width="64" class="weather-icon">
        ...
        fetchData(url.forecast(lat, lon), function (forecast) {
            ...
            for (let i = 7, len = forecastList.length; i<len; i+=8) {
                ...
                li.innerHTML = `
                    ...
                    <p class="label-1">${module.weekDayNames[date.getUTCDay()].slice(0, 3)}</p>
